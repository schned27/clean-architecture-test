...
{
    public class GetAllMoviesQueryHandler : IRequestHandler<GetAllMoviesQuery, List<MovieManagementModel>>
    {
        ...
        public async Task<List<MovieManagementModel>> Handle(GetAllMoviesQuery request,
